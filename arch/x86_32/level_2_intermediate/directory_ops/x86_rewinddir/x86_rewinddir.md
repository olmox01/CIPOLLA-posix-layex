# filepath: x86_rewinddir.md

# rewinddir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `rewinddir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_rewinddir_impl()` - Implementazione principale
- `x86_rewinddir_test()` - Test di funzionamento
