# filepath: x86_opendir.md

# opendir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `opendir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_opendir_impl()` - Implementazione principale
- `x86_opendir_test()` - Test di funzionamento
