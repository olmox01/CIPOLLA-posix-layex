# filepath: x86_readdir.md

# readdir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `readdir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_readdir_impl()` - Implementazione principale
- `x86_readdir_test()` - Test di funzionamento
