# filepath: x86_closedir.md

# closedir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `closedir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_closedir_impl()` - Implementazione principale
- `x86_closedir_test()` - Test di funzionamento
