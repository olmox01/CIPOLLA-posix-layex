# filepath: x86_telldir.md

# telldir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `telldir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_telldir_impl()` - Implementazione principale
- `x86_telldir_test()` - Test di funzionamento
