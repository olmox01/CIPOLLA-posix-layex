# filepath: x86_sleep.md

# sleep - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `sleep` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_sleep_impl()` - Implementazione principale
- `x86_sleep_test()` - Test di funzionamento
