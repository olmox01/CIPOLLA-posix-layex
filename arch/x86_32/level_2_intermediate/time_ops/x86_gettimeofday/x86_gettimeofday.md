# filepath: x86_gettimeofday.md

# gettimeofday - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `gettimeofday` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_gettimeofday_impl()` - Implementazione principale
- `x86_gettimeofday_test()` - Test di funzionamento
