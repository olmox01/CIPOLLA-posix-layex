# filepath: x86_nanosleep.md

# nanosleep - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `nanosleep` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_nanosleep_impl()` - Implementazione principale
- `x86_nanosleep_test()` - Test di funzionamento
