# filepath: x86_time.md

# time - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `time` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_time_impl()` - Implementazione principale
- `x86_time_test()` - Test di funzionamento
