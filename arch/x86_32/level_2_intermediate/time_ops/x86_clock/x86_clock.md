# filepath: x86_clock.md

# clock - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `clock` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_clock_impl()` - Implementazione principale
- `x86_clock_test()` - Test di funzionamento
