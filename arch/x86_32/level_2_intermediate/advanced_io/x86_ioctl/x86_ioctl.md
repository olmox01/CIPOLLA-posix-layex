# filepath: x86_ioctl.md

# ioctl - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `ioctl` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_ioctl_impl()` - Implementazione principale
- `x86_ioctl_test()` - Test di funzionamento
