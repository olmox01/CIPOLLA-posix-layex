# filepath: x86_select.md

# select - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `select` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_select_impl()` - Implementazione principale
- `x86_select_test()` - Test di funzionamento
