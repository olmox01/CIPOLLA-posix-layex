# filepath: x86_poll.md

# poll - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `poll` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_poll_impl()` - Implementazione principale
- `x86_poll_test()` - Test di funzionamento
