# filepath: x86_fcntl.md

# fcntl - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `fcntl` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_fcntl_impl()` - Implementazione principale
- `x86_fcntl_test()` - Test di funzionamento
