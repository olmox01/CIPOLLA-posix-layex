# filepath: x86_pipe.md

# pipe - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `pipe` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_pipe_impl()` - Implementazione principale
- `x86_pipe_test()` - Test di funzionamento
