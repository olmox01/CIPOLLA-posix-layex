# filepath: x86_dup2.md

# dup2 - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `dup2` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_dup2_impl()` - Implementazione principale
- `x86_dup2_test()` - Test di funzionamento
