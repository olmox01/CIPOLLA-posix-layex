# filepath: x86_rmdir.md

# rmdir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `rmdir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_rmdir_impl()` - Implementazione principale
- `x86_rmdir_test()` - Test di funzionamento
