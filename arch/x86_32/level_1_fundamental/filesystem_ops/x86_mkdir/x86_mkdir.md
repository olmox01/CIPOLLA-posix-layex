# filepath: x86_mkdir.md

# mkdir - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `mkdir` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_mkdir_impl()` - Implementazione principale
- `x86_mkdir_test()` - Test di funzionamento
