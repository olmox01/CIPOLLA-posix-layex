# filepath: x86_link.md

# link - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `link` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_link_impl()` - Implementazione principale
- `x86_link_test()` - Test di funzionamento
