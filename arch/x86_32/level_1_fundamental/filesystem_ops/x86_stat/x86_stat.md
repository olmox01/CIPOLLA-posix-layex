# filepath: x86_stat.md

# stat - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `stat` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_stat_impl()` - Implementazione principale
- `x86_stat_test()` - Test di funzionamento
