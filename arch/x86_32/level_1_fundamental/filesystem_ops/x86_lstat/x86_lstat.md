# filepath: x86_lstat.md

# lstat - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `lstat` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_lstat_impl()` - Implementazione principale
- `x86_lstat_test()` - Test di funzionamento
