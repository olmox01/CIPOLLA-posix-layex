# filepath: x86_chmod.md

# chmod - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `chmod` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_chmod_impl()` - Implementazione principale
- `x86_chmod_test()` - Test di funzionamento
