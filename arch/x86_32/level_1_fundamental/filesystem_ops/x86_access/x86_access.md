# filepath: x86_access.md

# access - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `access` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_access_impl()` - Implementazione principale
- `x86_access_test()` - Test di funzionamento
