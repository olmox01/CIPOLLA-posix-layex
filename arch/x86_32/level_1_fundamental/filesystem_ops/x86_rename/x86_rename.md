# filepath: x86_rename.md

# rename - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `rename` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_rename_impl()` - Implementazione principale
- `x86_rename_test()` - Test di funzionamento
