# filepath: x86_unlink.md

# unlink - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `unlink` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_unlink_impl()` - Implementazione principale
- `x86_unlink_test()` - Test di funzionamento
