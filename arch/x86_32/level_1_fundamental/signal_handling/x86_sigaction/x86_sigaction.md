# filepath: x86_sigaction.md

# sigaction - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `sigaction` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_sigaction_impl()` - Implementazione principale
- `x86_sigaction_test()` - Test di funzionamento
