# filepath: x86_pause.md

# pause - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `pause` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_pause_impl()` - Implementazione principale
- `x86_pause_test()` - Test di funzionamento
