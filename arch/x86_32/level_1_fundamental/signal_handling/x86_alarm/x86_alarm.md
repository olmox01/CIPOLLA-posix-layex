# filepath: x86_alarm.md

# alarm - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `alarm` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_alarm_impl()` - Implementazione principale
- `x86_alarm_test()` - Test di funzionamento
