# filepath: x86_kill.md

# kill - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `kill` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_kill_impl()` - Implementazione principale
- `x86_kill_test()` - Test di funzionamento
