# filepath: x86_execve.md

# execve - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `execve` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_execve_impl()` - Implementazione principale
- `x86_execve_test()` - Test di funzionamento
