# filepath: x86_exit.md

# exit - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `exit` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_exit_impl()` - Implementazione principale
- `x86_exit_test()` - Test di funzionamento
