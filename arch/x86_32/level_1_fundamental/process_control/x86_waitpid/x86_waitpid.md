# filepath: x86_waitpid.md

# waitpid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `waitpid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_waitpid_impl()` - Implementazione principale
- `x86_waitpid_test()` - Test di funzionamento
