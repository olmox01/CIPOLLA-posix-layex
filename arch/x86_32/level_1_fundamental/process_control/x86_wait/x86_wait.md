# filepath: x86_wait.md

# wait - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `wait` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_wait_impl()` - Implementazione principale
- `x86_wait_test()` - Test di funzionamento
