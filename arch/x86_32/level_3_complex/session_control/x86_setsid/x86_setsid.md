# filepath: x86_setsid.md

# setsid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `setsid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_setsid_impl()` - Implementazione principale
- `x86_setsid_test()` - Test di funzionamento
