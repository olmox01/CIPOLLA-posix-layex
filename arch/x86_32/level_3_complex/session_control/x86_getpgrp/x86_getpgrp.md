# filepath: x86_getpgrp.md

# getpgrp - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getpgrp` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getpgrp_impl()` - Implementazione principale
- `x86_getpgrp_test()` - Test di funzionamento
