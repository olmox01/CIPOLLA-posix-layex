# filepath: x86_getsid.md

# getsid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getsid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getsid_impl()` - Implementazione principale
- `x86_getsid_test()` - Test di funzionamento
