# filepath: x86_accept.md

# accept - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `accept` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_accept_impl()` - Implementazione principale
- `x86_accept_test()` - Test di funzionamento
