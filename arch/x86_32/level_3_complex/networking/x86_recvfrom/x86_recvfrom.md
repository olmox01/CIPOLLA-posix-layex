# filepath: x86_recvfrom.md

# recvfrom - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `recvfrom` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_recvfrom_impl()` - Implementazione principale
- `x86_recvfrom_test()` - Test di funzionamento
