# filepath: x86_socket.md

# socket - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `socket` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_socket_impl()` - Implementazione principale
- `x86_socket_test()` - Test di funzionamento
