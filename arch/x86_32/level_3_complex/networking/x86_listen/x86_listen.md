# filepath: x86_listen.md

# listen - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `listen` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_listen_impl()` - Implementazione principale
- `x86_listen_test()` - Test di funzionamento
