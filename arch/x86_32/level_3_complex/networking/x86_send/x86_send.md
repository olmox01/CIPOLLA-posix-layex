# filepath: x86_send.md

# send - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `send` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_send_impl()` - Implementazione principale
- `x86_send_test()` - Test di funzionamento
