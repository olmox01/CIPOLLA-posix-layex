# filepath: x86_bind.md

# bind - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `bind` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_bind_impl()` - Implementazione principale
- `x86_bind_test()` - Test di funzionamento
