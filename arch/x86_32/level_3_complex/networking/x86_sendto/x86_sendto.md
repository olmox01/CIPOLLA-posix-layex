# filepath: x86_sendto.md

# sendto - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `sendto` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_sendto_impl()` - Implementazione principale
- `x86_sendto_test()` - Test di funzionamento
