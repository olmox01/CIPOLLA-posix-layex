# filepath: x86_connect.md

# connect - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `connect` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_connect_impl()` - Implementazione principale
- `x86_connect_test()` - Test di funzionamento
