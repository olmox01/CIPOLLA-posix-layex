# filepath: x86_recv.md

# recv - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `recv` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_recv_impl()` - Implementazione principale
- `x86_recv_test()` - Test di funzionamento
