# filepath: x86_shmget.md

# shmget - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `shmget` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_shmget_impl()` - Implementazione principale
- `x86_shmget_test()` - Test di funzionamento
