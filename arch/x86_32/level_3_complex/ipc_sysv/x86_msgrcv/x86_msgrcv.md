# filepath: x86_msgrcv.md

# msgrcv - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `msgrcv` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_msgrcv_impl()` - Implementazione principale
- `x86_msgrcv_test()` - Test di funzionamento
