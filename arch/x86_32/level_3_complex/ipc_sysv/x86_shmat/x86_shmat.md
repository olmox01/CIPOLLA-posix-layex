# filepath: x86_shmat.md

# shmat - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `shmat` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_shmat_impl()` - Implementazione principale
- `x86_shmat_test()` - Test di funzionamento
