# filepath: x86_msgsnd.md

# msgsnd - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `msgsnd` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_msgsnd_impl()` - Implementazione principale
- `x86_msgsnd_test()` - Test di funzionamento
