# filepath: x86_shmctl.md

# shmctl - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `shmctl` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_shmctl_impl()` - Implementazione principale
- `x86_shmctl_test()` - Test di funzionamento
