# filepath: x86_shmdt.md

# shmdt - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `shmdt` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_shmdt_impl()` - Implementazione principale
- `x86_shmdt_test()` - Test di funzionamento
