# filepath: x86_msgctl.md

# msgctl - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `msgctl` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_msgctl_impl()` - Implementazione principale
- `x86_msgctl_test()` - Test di funzionamento
