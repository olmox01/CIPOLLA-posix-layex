# filepath: x86_pthread_detach.md

# pthread_detach - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_detach` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_pthread_detach_impl()` - Implementazione principale
- `x86_pthread_detach_test()` - Test di funzionamento
