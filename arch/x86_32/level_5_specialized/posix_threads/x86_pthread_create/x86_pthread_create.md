# filepath: x86_pthread_create.md

# pthread_create - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_create` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_pthread_create_impl()` - Implementazione principale
- `x86_pthread_create_test()` - Test di funzionamento
