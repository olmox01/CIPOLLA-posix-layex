# filepath: x86_pthread_join.md

# pthread_join - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_join` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_pthread_join_impl()` - Implementazione principale
- `x86_pthread_join_test()` - Test di funzionamento
