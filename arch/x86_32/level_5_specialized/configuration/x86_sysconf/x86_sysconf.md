# filepath: x86_sysconf.md

# sysconf - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `sysconf` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_sysconf_impl()` - Implementazione principale
- `x86_sysconf_test()` - Test di funzionamento
