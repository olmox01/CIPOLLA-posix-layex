# filepath: x86_aio_suspend.md

# aio_suspend - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_suspend` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_aio_suspend_impl()` - Implementazione principale
- `x86_aio_suspend_test()` - Test di funzionamento
