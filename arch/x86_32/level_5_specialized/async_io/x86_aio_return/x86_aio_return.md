# filepath: x86_aio_return.md

# aio_return - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_return` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_aio_return_impl()` - Implementazione principale
- `x86_aio_return_test()` - Test di funzionamento
