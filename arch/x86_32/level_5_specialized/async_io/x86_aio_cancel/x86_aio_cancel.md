# filepath: x86_aio_cancel.md

# aio_cancel - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_cancel` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_aio_cancel_impl()` - Implementazione principale
- `x86_aio_cancel_test()` - Test di funzionamento
