# filepath: x86_aio_read.md

# aio_read - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_read` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_aio_read_impl()` - Implementazione principale
- `x86_aio_read_test()` - Test di funzionamento
