# filepath: x86_setegid.md

# setegid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `setegid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_setegid_impl()` - Implementazione principale
- `x86_setegid_test()` - Test di funzionamento
