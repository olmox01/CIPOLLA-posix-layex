# filepath: x86_setgid.md

# setgid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `setgid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_setgid_impl()` - Implementazione principale
- `x86_setgid_test()` - Test di funzionamento
