# filepath: x86_setuid.md

# setuid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `setuid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_setuid_impl()` - Implementazione principale
- `x86_setuid_test()` - Test di funzionamento
