# filepath: x86_seteuid.md

# seteuid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `seteuid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_seteuid_impl()` - Implementazione principale
- `x86_seteuid_test()` - Test di funzionamento
