# filepath: x86_setgroups.md

# setgroups - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `setgroups` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_setgroups_impl()` - Implementazione principale
- `x86_setgroups_test()` - Test di funzionamento
