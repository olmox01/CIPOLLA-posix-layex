# filepath: x86_getgroups.md

# getgroups - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getgroups` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getgroups_impl()` - Implementazione principale
- `x86_getgroups_test()` - Test di funzionamento
