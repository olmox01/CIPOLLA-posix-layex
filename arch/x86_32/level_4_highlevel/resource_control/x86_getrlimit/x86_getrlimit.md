# filepath: x86_getrlimit.md

# getrlimit - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getrlimit` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getrlimit_impl()` - Implementazione principale
- `x86_getrlimit_test()` - Test di funzionamento
