# filepath: x86_getrusage.md

# getrusage - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getrusage` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getrusage_impl()` - Implementazione principale
- `x86_getrusage_test()` - Test di funzionamento
