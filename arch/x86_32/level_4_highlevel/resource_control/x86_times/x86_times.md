# filepath: x86_times.md

# times - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `times` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_times_impl()` - Implementazione principale
- `x86_times_test()` - Test di funzionamento
