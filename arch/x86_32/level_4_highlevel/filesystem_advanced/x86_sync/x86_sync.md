# filepath: x86_sync.md

# sync - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `sync` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_sync_impl()` - Implementazione principale
- `x86_sync_test()` - Test di funzionamento
