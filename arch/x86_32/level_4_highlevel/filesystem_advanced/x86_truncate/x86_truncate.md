# filepath: x86_truncate.md

# truncate - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `truncate` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_truncate_impl()` - Implementazione principale
- `x86_truncate_test()` - Test di funzionamento
