# filepath: x86_umount.md

# umount - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `umount` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_umount_impl()` - Implementazione principale
- `x86_umount_test()` - Test di funzionamento
