# filepath: x86_mount.md

# mount - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `mount` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_mount_impl()` - Implementazione principale
- `x86_mount_test()` - Test di funzionamento
