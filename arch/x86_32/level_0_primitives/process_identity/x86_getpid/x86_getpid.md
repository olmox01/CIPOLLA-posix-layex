# filepath: x86_getpid.md

# getpid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getpid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getpid_impl()` - Implementazione principale
- `x86_getpid_test()` - Test di funzionamento
