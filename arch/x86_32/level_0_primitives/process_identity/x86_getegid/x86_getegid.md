# filepath: x86_getegid.md

# getegid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getegid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getegid_impl()` - Implementazione principale
- `x86_getegid_test()` - Test di funzionamento
