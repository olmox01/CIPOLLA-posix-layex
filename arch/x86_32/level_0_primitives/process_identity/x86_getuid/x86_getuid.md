# filepath: x86_getuid.md

# getuid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getuid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getuid_impl()` - Implementazione principale
- `x86_getuid_test()` - Test di funzionamento
