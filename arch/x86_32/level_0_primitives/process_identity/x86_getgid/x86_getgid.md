# filepath: x86_getgid.md

# getgid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getgid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getgid_impl()` - Implementazione principale
- `x86_getgid_test()` - Test di funzionamento
