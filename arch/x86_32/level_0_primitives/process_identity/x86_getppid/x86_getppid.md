# filepath: x86_getppid.md

# getppid - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `getppid` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_getppid_impl()` - Implementazione principale
- `x86_getppid_test()` - Test di funzionamento
