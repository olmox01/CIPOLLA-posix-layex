# filepath: x86_open.md

# open - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `open` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_open_impl()` - Implementazione principale
- `x86_open_test()` - Test di funzionamento
