# filepath: x86_lseek.md

# lseek - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `lseek` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_lseek_impl()` - Implementazione principale
- `x86_lseek_test()` - Test di funzionamento
