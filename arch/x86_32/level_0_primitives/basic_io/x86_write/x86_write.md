# filepath: x86_write.md

# write - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `write` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_write_impl()` - Implementazione principale
- `x86_write_test()` - Test di funzionamento
