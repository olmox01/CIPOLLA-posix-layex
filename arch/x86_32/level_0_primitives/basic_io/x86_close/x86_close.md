# filepath: x86_close.md

# close - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `close` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_close_impl()` - Implementazione principale
- `x86_close_test()` - Test di funzionamento
