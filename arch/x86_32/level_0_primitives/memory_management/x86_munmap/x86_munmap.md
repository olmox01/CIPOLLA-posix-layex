# filepath: x86_munmap.md

# munmap - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `munmap` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_munmap_impl()` - Implementazione principale
- `x86_munmap_test()` - Test di funzionamento
