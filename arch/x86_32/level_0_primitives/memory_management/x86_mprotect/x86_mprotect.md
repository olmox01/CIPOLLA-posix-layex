# filepath: x86_mprotect.md

# mprotect - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `mprotect` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_mprotect_impl()` - Implementazione principale
- `x86_mprotect_test()` - Test di funzionamento
