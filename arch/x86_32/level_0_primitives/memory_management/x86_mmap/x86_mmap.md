# filepath: x86_mmap.md

# mmap - 32-bit Implementation

## Descrizione
Implementazione della system call POSIX `mmap` per architettura 32-bit.
...
### Funzioni Esportate
- `x86_mmap_impl()` - Implementazione principale
- `x86_mmap_test()` - Test di funzionamento
