...
# geteuid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `geteuid` per architettura 64-bit.
...
### Funzioni Esportate
- `geteuid_impl()` - Implementazione principale
- `geteuid_test()` - Test di funzionamento
