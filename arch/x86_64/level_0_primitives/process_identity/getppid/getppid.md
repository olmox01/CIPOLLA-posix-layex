...
# getppid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getppid` per architettura 64-bit.
...
### Funzioni Esportate
- `getppid_impl()` - Implementazione principale
- `getppid_test()` - Test di funzionamento
