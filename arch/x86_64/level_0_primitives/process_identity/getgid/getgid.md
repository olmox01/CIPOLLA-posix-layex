...
# getgid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getgid` per architettura 64-bit.
...
### Funzioni Esportate
- `getgid_impl()` - Implementazione principale
- `getgid_test()` - Test di funzionamento
