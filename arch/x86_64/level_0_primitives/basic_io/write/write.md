...
# write - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `write` per architettura 64-bit.
...
### Funzioni Esportate
- `write_impl()` - Implementazione principale
- `write_test()` - Test di funzionamento
