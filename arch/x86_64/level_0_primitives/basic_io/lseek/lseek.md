...
# lseek - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `lseek` per architettura 64-bit.
...
### Funzioni Esportate
- `lseek_impl()` - Implementazione principale
- `lseek_test()` - Test di funzionamento
