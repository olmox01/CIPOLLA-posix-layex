...
# sbrk - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `sbrk` per architettura 64-bit.
...
### Funzioni Esportate
- `sbrk_impl()` - Implementazione principale
- `sbrk_test()` - Test di funzionamento
