# filepath: mprotect.md

# mprotect - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `mprotect` per architettura 64-bit.
...
### Funzioni Esportate
- `mprotect_impl()` - Implementazione principale
- `mprotect_test()` - Test di funzionamento
