...
# brk - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `brk` per architettura 64-bit.
...
### Funzioni Esportate
- `brk_impl()` - Implementazione principale
- `brk_test()` - Test di funzionamento
