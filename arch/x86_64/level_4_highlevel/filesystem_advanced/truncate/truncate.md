# filepath: truncate.md

# truncate - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `truncate` per architettura 64-bit.
...
### Funzioni Esportate
- `truncate_impl()` - Implementazione principale
- `truncate_test()` - Test di funzionamento
