...
# fsync - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `fsync` per architettura 64-bit.
...
### Funzioni Esportate
- `fsync_impl()` - Implementazione principale
- `fsync_test()` - Test di funzionamento
