# filepath: fdatasync.md

# fdatasync - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `fdatasync` per architettura 64-bit.
...
### Funzioni Esportate
- `fdatasync_impl()` - Implementazione principale
- `fdatasync_test()` - Test di funzionamento
