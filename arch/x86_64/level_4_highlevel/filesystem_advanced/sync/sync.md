...
# sync - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `sync` per architettura 64-bit.
...
### Funzioni Esportate
- `sync_impl()` - Implementazione principale
- `sync_test()` - Test di funzionamento
