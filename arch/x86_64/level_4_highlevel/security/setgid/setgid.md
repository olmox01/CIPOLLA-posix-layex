...
# setgid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `setgid` per architettura 64-bit.
...
### Funzioni Esportate
- `setgid_impl()` - Implementazione principale
- `setgid_test()` - Test di funzionamento
