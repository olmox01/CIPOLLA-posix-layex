...
# setegid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `setegid` per architettura 64-bit.
...
### Funzioni Esportate
- `setegid_impl()` - Implementazione principale
- `setegid_test()` - Test di funzionamento
