# filepath: setgroups.md

# setgroups - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `setgroups` per architettura 64-bit.
...
### Funzioni Esportate
- `setgroups_impl()` - Implementazione principale
- `setgroups_test()` - Test di funzionamento
