# filepath: getgroups.md

# getgroups - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getgroups` per architettura 64-bit.
...
### Funzioni Esportate
- `getgroups_impl()` - Implementazione principale
- `getgroups_test()` - Test di funzionamento
