# filepath: gettimeofday.md

# gettimeofday - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `gettimeofday` per architettura 64-bit.
...
### Funzioni Esportate
- `gettimeofday_impl()` - Implementazione principale
- `gettimeofday_test()` - Test di funzionamento
