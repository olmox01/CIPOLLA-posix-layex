# filepath: nanosleep.md

# nanosleep - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `nanosleep` per architettura 64-bit.
...
### Funzioni Esportate
- `nanosleep_impl()` - Implementazione principale
- `nanosleep_test()` - Test di funzionamento
