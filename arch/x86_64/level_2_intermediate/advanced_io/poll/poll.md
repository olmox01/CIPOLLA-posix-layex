...
# poll - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `poll` per architettura 64-bit.
...
### Funzioni Esportate
- `poll_impl()` - Implementazione principale
- `poll_test()` - Test di funzionamento
