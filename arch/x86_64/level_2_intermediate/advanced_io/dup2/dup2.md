...
# dup2 - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `dup2` per architettura 64-bit.
...
### Funzioni Esportate
- `dup2_impl()` - Implementazione principale
- `dup2_test()` - Test di funzionamento
