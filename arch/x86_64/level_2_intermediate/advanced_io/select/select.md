...
# select - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `select` per architettura 64-bit.
...
### Funzioni Esportate
- `select_impl()` - Implementazione principale
- `select_test()` - Test di funzionamento
