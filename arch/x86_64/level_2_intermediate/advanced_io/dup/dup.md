...
# dup - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `dup` per architettura 64-bit.
...
### Funzioni Esportate
- `dup_impl()` - Implementazione principale
- `dup_test()` - Test di funzionamento
