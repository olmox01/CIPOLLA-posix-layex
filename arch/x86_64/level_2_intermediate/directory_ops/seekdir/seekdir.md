...
# seekdir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `seekdir` per architettura 64-bit.
...
### Funzioni Esportate
- `seekdir_impl()` - Implementazione principale
- `seekdir_test()` - Test di funzionamento
