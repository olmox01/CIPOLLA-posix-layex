...
# opendir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `opendir` per architettura 64-bit.
...
### Funzioni Esportate
- `opendir_impl()` - Implementazione principale
- `opendir_test()` - Test di funzionamento
