...
# readdir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `readdir` per architettura 64-bit.
...
### Funzioni Esportate
- `readdir_impl()` - Implementazione principale
- `readdir_test()` - Test di funzionamento
