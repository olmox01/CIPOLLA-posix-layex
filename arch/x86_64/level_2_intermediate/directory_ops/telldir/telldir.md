...
# telldir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `telldir` per architettura 64-bit.
...
### Funzioni Esportate
- `telldir_impl()` - Implementazione principale
- `telldir_test()` - Test di funzionamento
