# filepath: rewinddir.md

# rewinddir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `rewinddir` per architettura 64-bit.
...
### Funzioni Esportate
- `rewinddir_impl()` - Implementazione principale
- `rewinddir_test()` - Test di funzionamento
