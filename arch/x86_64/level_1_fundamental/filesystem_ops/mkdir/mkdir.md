...
# mkdir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `mkdir` per architettura 64-bit.
...
### Funzioni Esportate
- `mkdir_impl()` - Implementazione principale
- `mkdir_test()` - Test di funzionamento
