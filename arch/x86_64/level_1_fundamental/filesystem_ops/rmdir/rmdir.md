...
# rmdir - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `rmdir` per architettura 64-bit.
...
### Funzioni Esportate
- `rmdir_impl()` - Implementazione principale
- `rmdir_test()` - Test di funzionamento
