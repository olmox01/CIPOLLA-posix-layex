...
# fstat - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `fstat` per architettura 64-bit.
...
### Funzioni Esportate
- `fstat_impl()` - Implementazione principale
- `fstat_test()` - Test di funzionamento
