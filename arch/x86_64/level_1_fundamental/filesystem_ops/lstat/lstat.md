...
# lstat - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `lstat` per architettura 64-bit.
...
### Funzioni Esportate
- `lstat_impl()` - Implementazione principale
- `lstat_test()` - Test di funzionamento
