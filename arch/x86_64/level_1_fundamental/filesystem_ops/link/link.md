...
# link - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `link` per architettura 64-bit.
...
### Funzioni Esportate
- `link_impl()` - Implementazione principale
- `link_test()` - Test di funzionamento
