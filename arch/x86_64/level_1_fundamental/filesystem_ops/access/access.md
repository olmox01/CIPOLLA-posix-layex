...
# access - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `access` per architettura 64-bit.
...
### Funzioni Esportate
- `access_impl()` - Implementazione principale
- `access_test()` - Test di funzionamento
