...
# chown - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `chown` per architettura 64-bit.
...
### Funzioni Esportate
- `chown_impl()` - Implementazione principale
- `chown_test()` - Test di funzionamento
