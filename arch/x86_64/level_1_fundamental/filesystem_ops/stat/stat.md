...
# stat - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `stat` per architettura 64-bit.
...
### Funzioni Esportate
- `stat_impl()` - Implementazione principale
- `stat_test()` - Test di funzionamento
