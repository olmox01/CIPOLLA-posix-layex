...
# wait - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `wait` per architettura 64-bit.
...
### Funzioni Esportate
- `wait_impl()` - Implementazione principale
- `wait_test()` - Test di funzionamento
