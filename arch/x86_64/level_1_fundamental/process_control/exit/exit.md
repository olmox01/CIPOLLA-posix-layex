...
# exit - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `exit` per architettura 64-bit.
...
### Funzioni Esportate
- `exit_impl()` - Implementazione principale
- `exit_test()` - Test di funzionamento
