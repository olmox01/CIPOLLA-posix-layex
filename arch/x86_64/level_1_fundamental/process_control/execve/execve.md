...
# execve - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `execve` per architettura 64-bit.
...
### Funzioni Esportate
- `execve_impl()` - Implementazione principale
- `execve_test()` - Test di funzionamento
