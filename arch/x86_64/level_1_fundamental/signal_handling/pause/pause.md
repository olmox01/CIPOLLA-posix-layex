...
# pause - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pause` per architettura 64-bit.
...
### Funzioni Esportate
- `pause_impl()` - Implementazione principale
- `pause_test()` - Test di funzionamento
