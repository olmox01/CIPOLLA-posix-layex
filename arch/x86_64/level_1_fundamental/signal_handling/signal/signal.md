...
# signal - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `signal` per architettura 64-bit.
...
### Funzioni Esportate
- `signal_impl()` - Implementazione principale
- `signal_test()` - Test di funzionamento
