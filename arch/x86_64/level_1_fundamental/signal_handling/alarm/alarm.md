...
# alarm - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `alarm` per architettura 64-bit.
...
### Funzioni Esportate
- `alarm_impl()` - Implementazione principale
- `alarm_test()` - Test di funzionamento
