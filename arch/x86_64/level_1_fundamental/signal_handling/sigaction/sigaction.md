# filepath: sigaction.md

# sigaction - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `sigaction` per architettura 64-bit.
...
### Funzioni Esportate
- `sigaction_impl()` - Implementazione principale
- `sigaction_test()` - Test di funzionamento
