...
# socket - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `socket` per architettura 64-bit.
...
### Funzioni Esportate
- `socket_impl()` - Implementazione principale
- `socket_test()` - Test di funzionamento
