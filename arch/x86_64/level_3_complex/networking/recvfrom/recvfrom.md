# filepath: recvfrom.md

# recvfrom - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `recvfrom` per architettura 64-bit.
...
### Funzioni Esportate
- `recvfrom_impl()` - Implementazione principale
- `recvfrom_test()` - Test di funzionamento
