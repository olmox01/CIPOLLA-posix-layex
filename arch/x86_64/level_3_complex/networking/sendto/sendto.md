...
# sendto - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `sendto` per architettura 64-bit.
...
### Funzioni Esportate
- `sendto_impl()` - Implementazione principale
- `sendto_test()` - Test di funzionamento
