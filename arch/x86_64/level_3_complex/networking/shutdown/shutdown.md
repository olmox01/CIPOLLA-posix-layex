# filepath: shutdown.md

# shutdown - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `shutdown` per architettura 64-bit.
...
### Funzioni Esportate
- `shutdown_impl()` - Implementazione principale
- `shutdown_test()` - Test di funzionamento
