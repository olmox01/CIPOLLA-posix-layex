...
# listen - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `listen` per architettura 64-bit.
...
### Funzioni Esportate
- `listen_impl()` - Implementazione principale
- `listen_test()` - Test di funzionamento
