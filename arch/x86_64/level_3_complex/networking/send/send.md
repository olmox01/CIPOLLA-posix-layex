...
# send - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `send` per architettura 64-bit.
...
### Funzioni Esportate
- `send_impl()` - Implementazione principale
- `send_test()` - Test di funzionamento
