...
# getpgrp - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getpgrp` per architettura 64-bit.
...
### Funzioni Esportate
- `getpgrp_impl()` - Implementazione principale
- `getpgrp_test()` - Test di funzionamento
