...
# getsid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getsid` per architettura 64-bit.
...
### Funzioni Esportate
- `getsid_impl()` - Implementazione principale
- `getsid_test()` - Test di funzionamento
