...
# getpgid - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `getpgid` per architettura 64-bit.
...
### Funzioni Esportate
- `getpgid_impl()` - Implementazione principale
- `getpgid_test()` - Test di funzionamento
