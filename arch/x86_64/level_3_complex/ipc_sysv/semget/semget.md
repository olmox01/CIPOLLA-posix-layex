...
# semget - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `semget` per architettura 64-bit.
...
### Funzioni Esportate
- `semget_impl()` - Implementazione principale
- `semget_test()` - Test di funzionamento
