...
# shmat - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `shmat` per architettura 64-bit.
...
### Funzioni Esportate
- `shmat_impl()` - Implementazione principale
- `shmat_test()` - Test di funzionamento
