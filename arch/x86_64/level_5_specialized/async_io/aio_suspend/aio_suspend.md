# filepath: aio_suspend.md

# aio_suspend - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_suspend` per architettura 64-bit.
...
### Funzioni Esportate
- `aio_suspend_impl()` - Implementazione principale
- `aio_suspend_test()` - Test di funzionamento
