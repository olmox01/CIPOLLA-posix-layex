# filepath: aio_write.md

# aio_write - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_write` per architettura 64-bit.
...
### Funzioni Esportate
- `aio_write_impl()` - Implementazione principale
- `aio_write_test()` - Test di funzionamento
