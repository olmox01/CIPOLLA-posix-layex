# filepath: aio_return.md

# aio_return - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_return` per architettura 64-bit.
...
### Funzioni Esportate
- `aio_return_impl()` - Implementazione principale
- `aio_return_test()` - Test di funzionamento
