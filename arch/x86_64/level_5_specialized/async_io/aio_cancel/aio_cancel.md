# filepath: aio_cancel.md

# aio_cancel - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_cancel` per architettura 64-bit.
...
### Funzioni Esportate
- `aio_cancel_impl()` - Implementazione principale
- `aio_cancel_test()` - Test di funzionamento
