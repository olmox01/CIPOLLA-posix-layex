# filepath: aio_read.md

# aio_read - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `aio_read` per architettura 64-bit.
...
### Funzioni Esportate
- `aio_read_impl()` - Implementazione principale
- `aio_read_test()` - Test di funzionamento
