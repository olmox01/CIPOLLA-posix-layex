# filepath: pthread_detach.md

# pthread_detach - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_detach` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_detach_impl()` - Implementazione principale
- `pthread_detach_test()` - Test di funzionamento
