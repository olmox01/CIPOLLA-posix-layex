# filepath: pthread_mutex_lock.md

# pthread_mutex_lock - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_mutex_lock` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_mutex_lock_impl()` - Implementazione principale
- `pthread_mutex_lock_test()` - Test di funzionamento
