# filepath: pthread_mutex_init.md

# pthread_mutex_init - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_mutex_init` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_mutex_init_impl()` - Implementazione principale
- `pthread_mutex_init_test()` - Test di funzionamento
