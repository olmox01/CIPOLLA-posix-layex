# filepath: pthread_create.md

# pthread_create - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_create` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_create_impl()` - Implementazione principale
- `pthread_create_test()` - Test di funzionamento
