# filepath: pthread_join.md

# pthread_join - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_join` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_join_impl()` - Implementazione principale
- `pthread_join_test()` - Test di funzionamento
