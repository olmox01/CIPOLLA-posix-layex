# filepath: pthread_exit.md

# pthread_exit - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `pthread_exit` per architettura 64-bit.
...
### Funzioni Esportate
- `pthread_exit_impl()` - Implementazione principale
- `pthread_exit_test()` - Test di funzionamento
