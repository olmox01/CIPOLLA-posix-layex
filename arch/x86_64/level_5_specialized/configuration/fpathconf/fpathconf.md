# filepath: fpathconf.md

# fpathconf - 64-bit Implementation

## Descrizione
Implementazione della system call POSIX `fpathconf` per architettura 64-bit.
...
### Funzioni Esportate
- `fpathconf_impl()` - Implementazione principale
- `fpathconf_test()` - Test di funzionamento
